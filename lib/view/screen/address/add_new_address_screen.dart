                  ...
                  return Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        //         ? CircleAvatar(backgroundColor: Color(0xffDAA50F), radius: 5) : SizedBox.shrink(),
                        //        SizedBox(width: 8),
                        //        Expanded(
                        //       child: Text(locationProvider.errorMessage ?? "",
                        //         style: Theme.of(context).textTheme.headline2.copyWith(fontSize: Dimensions.FONT_SIZE_SMALL, color: Color(0xffDAA50F), height: 1),
                        //       ),
                        //     )
                        //   ],
                        // ),
