            ...
            builder: (ctx, details, child) {
              ...
              return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Expanded(
                        child: Padding(padding: const EdgeInsets.all(2.0),
                          child: GridView.builder(
                            ...
                            itemBuilder: (ctx, i) {
                              return InkWell(
                                onTap: () => Provider.of<ProductDetailsProvider>(context, listen: false).setCartVariationIndex(widget.product, index, i, context),
                                child: Container(
                                  decoration: BoxDecoration(
                                    borderRadius: BorderRadius.circular(5),
                ...
                Row(children: [
                  ...
                  QuantityButton(isIncrement: false, quantity: details.quantity, stock: _stock, minimumOrderQuantity: widget.product.minimumOrderQuantity,),
                  Text(details.quantity.toString(), style: titilliumSemiBold),
                  QuantityButton(isIncrement: true, quantity: details.quantity, stock: _stock,minimumOrderQuantity: widget.product.minimumOrderQuantity),
                ]),
                SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                ...
                Row(children: [
                  ...
                  Expanded(
                    child: CustomButton(buttonText: getTranslated(_stock < widget.product.minimumOrderQuantity ?
